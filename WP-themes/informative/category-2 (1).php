	...
	<div id="main-content">	
		...
		<div class="one-column">
			...
			<?php $paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
				query_posts('cat=2,-41&paged=' . $paged); ?>
...
<div id="right-sidebar-area">
			<div class="cat-column">
				<?php query_posts('cat=14&posts_per_page=10'); ?>
				<h2><?php _e('Några artiklar från '); ?><?php wp_list_categories('include=14&title_li='); ?></h2>	
				<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			...
			<div class="cat-column">
				<?php query_posts('cat=21&posts_per_page=10'); ?>
				<h2><?php _e('Några artiklar från '); ?><?php wp_list_categories('include=21&title_li='); ?></h2>				
				<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
				<li><a href="<?php the_permalink() ?>">				
				<?php the_title(); ?></a></li>
			<?php endwhile; endif; wp_reset_query();?>
