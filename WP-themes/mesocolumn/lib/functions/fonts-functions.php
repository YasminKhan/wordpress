...
<?php } else {
wp_register_style('body_gwf', $http . "://fonts.googleapis.com/css?family=" . $bodytype . ":" . $font_var);
wp_enqueue_style( 'body_gwf');
}
if ($un_headtype == "" || $un_headtype == "Choose a font" || in_array($un_headtype, $safe_font)){ ?>
<?php } else {
wp_register_style('headline_gwf', $http . "://fonts.googleapis.com/css?family=" . $headtype . ":" . $font_var);
wp_enqueue_style( 'headline_gwf');
}
if ($un_navtype == "" || $un_navtype == "Choose a font" || in_array($un_navtype, $safe_font)){  ?>
<?php } else {
wp_register_style('nav_gwf', $http . "://fonts.googleapis.com/css?family=" . $navtype . ":" . $font_var);
