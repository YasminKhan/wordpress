<?php //echo get_option( 'show_on_front' );
if ( 'page' == get_option( 'show_on_front' ) ) { get_template_part( 'page' ); } else { ?>
...
<?php if( ($featcat1 == '' && $featcat2 == '' && $featcat3 == '' && $featcat4 == '' && $featcat5 == '' && $featcat6 == '') || ($featcat1 == 'Choose a category' && $featcat2 == 'Choose a category' && $featcat3 == 'Choose a category' && $featcat4 == 'Choose a category' && $featcat5 == 'Choose a category' && $featcat6 == 'Choose a category') ): ?>

<?php
$archive_excerpt = get_theme_option('post_custom_excerpt');
$excerpt_moretext = get_theme_option('post_excerpt_moretext');
if($archive_excerpt == '0') { $archive_excerpt = '0'; } else if( empty($archive_excerpt) ) { $archive_excerpt = '200'; }
