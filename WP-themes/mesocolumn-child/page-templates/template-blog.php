...
<?php echo dez_get_featured_post_image("<div class='post-thumb in-archive'>".$thepostlink, "</a></div>", 300, 300, "alignleft", "medium", dez_get_singular_cat('false'),the_title_attribute('echo=0'), true); ?>
