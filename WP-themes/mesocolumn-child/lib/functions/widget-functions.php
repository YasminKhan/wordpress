...
<li class="<?php echo dez_get_has_thumb_check(); ?>">
<?php if($feat_thumb == 'yes') { ?>
<?php echo dez_get_featured_post_image('','',50,50,'featpost alignleft','thumbnail', dez_get_singular_cat('false'), the_title_attribute('echo=0'), false); ?>
<?php } ?>
<div class="feat-post-meta">
<div class="feat-title"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></div>
<small><?php echo the_time( get_option( 'date_format' ) ); ?><span class="widget-feat-comment"><?php if ( comments_open() ) { ?> - <?php comments_popup_link(__('No Comment',TEMPLATE_DOMAIN), __('1 Comment',TEMPLATE_DOMAIN), __('% Comments',TEMPLATE_DOMAIN) ); ?></span><?php } ?>
</small>
</div>
</li>
<?php endwhile; ?>
