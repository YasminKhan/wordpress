...
$cat_bg_color = get_option($cat_value_option);
...
$page_bg_color = get_option($page_value_option);
$pagename_val = ( !empty($page_bg_color) ) ? "tn_page_color_" . $page_id : "";
endif;

!empty ( $class_names )
and $class_names = ' class="'. esc_attr( $the_class_names . ' ' . $item_desc . ' ' . $have_icon . ' ' . $catname_val . ' ' . $pagename_val ) . '"';
...
return $before . "<img width='" . $width . "' height='auto' class='" . $class . "' src='" . $import_img . "' alt='" . $alt . "' title='" . $title . "' />" . $after;
...
if($default == 'true'):
return $before . "<img width='" . $width . "' height='auto' class='" . $class . "' src='" . get_template_directory_uri() . '/images/post-default.png' . "' alt='" . $alt . "' title='" . $title . "' />" . $after;
endif;
}
}
endif;
...
if($default == 'true'):
return $before . "<img width='" . $width . "' height='auto' class='" . $class . "' src='" . get_template_directory_uri() . '/images/slider-default.png' . "' alt='" . $alt . "' title='" . $title . "' />" . $after;
endif;
}
}
endif;
