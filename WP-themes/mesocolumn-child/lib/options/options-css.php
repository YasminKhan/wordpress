...
#woo-container p.price,.wp-pagenavi a, #woo-container span.price, #custom ul.product_list_widget li span.amount,span.pricebox  {background: none repeat scroll 0 0 <?php echo dehex($main_color, 18); ?>;}
...
?>
#custom footer.footer-bottom {background-color: <?php echo $footer_bottom_color; ?>;color:#fff !important;}<?php } ?>
<?php global $wp_cats2;
foreach ($wp_cats2 as $cat_value) {
$cat_id = get_cat_ID($cat_value);
$cat_value_option = 'tn_cat_color_' . $cat_id;
?>
<?php if( get_option($cat_value_option) ): ?>
#main-navigation li.menu-item-object-category.<?php echo $cat_value_option; ?> a {border-bottom: 5px solid <?php echo get_option($cat_value_option); ?>;}
#main-navigation ul.sf-menu li.menu-item-object-category.<?php echo $cat_value_option; ?>:hover {background-color: <?php echo get_option($cat_value_option); ?>;}
#main-navigation .sf-menu li.menu-item-object-category.<?php echo $cat_value_option; ?> a:hover {color: #fff !important;
background-color: <?php echo get_option($cat_value_option); ?>;}
aside.home-feat-cat h4.homefeattitle.feat_<?php echo $cat_value_option; ?> {border-bottom: 5px solid <?php echo get_option($cat_value_option); ?>;}
h2.header-title.feat_<?php echo $cat_value_option; ?> {
background-color: <?php echo get_option($cat_value_option); ?>;
padding: 1% 2%;
width:95%;
color: white;
}
#custom .archive_<?php echo $cat_value_option; ?> h1.post-title a {color: <?php echo get_option($cat_value_option); ?> !important;}
aside.home-feat-cat.post_<?php echo $cat_value_option; ?> .widget a, aside.home-feat-cat.post_<?php echo $cat_value_option; ?> article a {color: <?php echo get_option($cat_value_option); ?>;}
#custom #post-entry.archive_<?php echo $cat_value_option; ?> article .post-meta a:hover {color: <?php echo get_option($cat_value_option); ?> !important;}
#main-navigation .sf-menu li.menu-item-object-category.<?php echo $cat_value_option; ?> ul  {background-color: <?php echo get_option($cat_value_option); ?>;background-image: none;}
#main-navigation .sf-menu li.menu-item-object-category.<?php echo $cat_value_option; ?> ul li a:hover  {background-color: <?php echo dehex( get_option($cat_value_option), -20 ); ?>;background-image: none;}
<?php endif; ?>
<?php } ?>
<?php global $wp_pages;
...
?>
<?php if( get_option($page_value_option) ): ?>
#main-navigation li.menu-item-object-page.<?php echo $page_value_option; ?> a {border-bottom: 5px solid <?php echo get_option($page_value_option); ?>;}
#main-navigation ul.sf-menu li.menu-item-object-page.<?php echo $page_value_option; ?>:hover {background-color: <?php echo get_option($page_value_option); ?>;}
#main-navigation .sf-menu li.menu-item-object-page.<?php echo $page_value_option; ?> a:hover {color: #fff !important;
background-color: <?php echo get_option($page_value_option); ?>;}
#main-navigation .sf-menu li.menu-item-object-page.<?php echo $page_value_option; ?> ul  {background-color: <?php echo get_option($page_value_option); ?>;background-image: none;}
#main-navigation .sf-menu li.menu-item-object-page.<?php echo $page_value_option; ?> ul li a:hover  {background-color: <?php echo dehex( get_option($page_value_option), -20 ); ?> !important;background-image: none;}
<?php endif; ?>
<?php } ?>